            ...
            <div class="row">
                ...
                <div class="col-6">
                    <div class="mb-3">
                        ...
                        <input class="form-control<?= ($validator->hasError('director-select')) ? ' is-invalid' : ''; ?>" list="directorSuggest" placeholder="Type to search director..." id="directorInput">
                ...
                <div class="col-6">
                    <div class="mb-3">
                        ...
                        <input class="form-control<?= ($validator->hasError('network-select')) ? ' is-invalid' : ''; ?>" list="networkSuggest" placeholder="Type to search network..." id="networkInput">
                ...
                <div class="col-6">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control<?= ($validator->hasError('drama-episode')) ? ' is-invalid' : ''; ?>" id="dramaEpisode" name="drama-episode">
                    </div>
                </div>
                <div class="col-6">
                    <div class="mb-3">
                        <label for="countrySuggest" class="form-label">Country</label>
                        <input class="form-control<?= ($validator->hasError('country-select')) ? ' is-invalid' : ''; ?>" list="countrySuggest" placeholder="Type to search country..." id="countryInput">
                ...
                <div class="col-6">
                    <div class="mb-3">
                        ...
                        <input class="form-control<?= ($validator->hasError('language-select')) ? ' is-invalid' : ''; ?>" list="languageSuggest" placeholder="Type to search language..." id="languageInput">
            ...
            <div class="row">
                <div class="col-6">
                    <div class="mb-3">
                        ...
                        <input type="date" name="drama-Begin" id="dramaBegin" class="form-control<?= ($validator->hasError('drama-Begin')) ? ' is-invalid' : ''; ?>">
                    </div>
                </div>
                <div class="col-6">
                    <div class="mb-3">
                        <label for="dramaEnd" class="form-label">Last Episode</label>
                        <input type="date" name="drama-End" id="dramaEnd" class="form-control<?= ($validator->hasError('drama-End')) ? ' is-invalid' : ''; ?>">
                    </div>
                </div>
            </div>
            <div class="row">
